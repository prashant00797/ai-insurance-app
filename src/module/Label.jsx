  ...
  return (
    <div className="gap-5 mb-5 grid grid-cols-2 lg:flex lg:items-center lg:gap-20">
      <div
        ...
        className="bg-primary-600 text-white rounded-default w-full min-h-10 text-center p-2 cursor-pointer hover:brightness-110"
      >
      ...
      {__status.map((stats, idx) => {
        return (
          <div
            key={idx}
            className={`${statusStyles[stats]} text-white rounded-default w-full min-h-10 text-center p-2 cursor-pointer hover:brightness-110`}
