const CardPageUI = () => {
  return (
    <div className="h-full p-7">
      ...
      <div className="shadow-level-1 bg-primary-100 h-20 p-2 rounded-default mb-15">
        <div className="flex items-baseline gap-1.5 mb-2">
          <p className="text-gray-900 text-card-title font-semibold">
            🛄We have found 2 denied Claims and 1 pending.
          </p>
          <p className="text-gray-500 text-body font-light">
            See the cards below
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 p-2 border-amber-500 gap-5">
        {[1, 2, 3].map(() => {
          return (
            <div className=" shadow-level-2 w-[30vmax]">
